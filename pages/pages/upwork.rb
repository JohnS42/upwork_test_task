class Upwork
  ...
  # locators
  SEARCH_BOX = { xpath: '(//*[contains(@class, "navbar-collapse")]//input[@type="search"])[2]' }
  MAGNIFYING_GLASS = { xpath: '(//button[@type="submit"]/span[1])[2]' }
  SEARCH_SWITCHER_OPENER = { xpath: '(//button[contains(@class, "dropdown-toggle")]/span[contains(@class, "air-icon-arrow-expand")])[3]' }
  SEARCH_FIND_FREELANCERS_SWITCHER = { xpath: '(//*[@id="search-dropdown"]/li[@data-label="Freelancers"]/a)[3]' }
